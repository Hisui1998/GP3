...
VECTOR2 GameBoard::GetDrawLT(void)
{
	return drawLT;
}

void GameBoard::SetHolePos(VECTOR2 pos)
{
	hole->SetPos(pos);
}

VECTOR2 GameBoard::GetHolePos(void)
{
	return hole->GetPos();
}
...
void GameBoard::ReSize(VECTOR2 vec)
{
	...
	hole = std::make_unique<PieceHole>();
}
